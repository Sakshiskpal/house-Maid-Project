...
<html>
    ...
    <main>
        <div class="main-seeting">
            <div class="section-1">
                <div class="settings-option" name="menu"><a href="viewUsers.jsp" name="user">Users</a></div>
                <div class="settings-option" name="menu"><a href="viewWorker.jsp" name="worker">View Workers</a></div>
                <div class="settings-option" name="menu"><a href="viewComplain.jsp" name="complain">View complains</a></div>
                <div class="settings-option" name="menu"><a href="viewFeedback.jsp" name="feedback">View Feedback</a></div>
                <div class="settings-option" name="menu"><a href="viewContact.jsp" name="contacts">View contacts</a></div>
            </div>
            <div class="section-2">
                <div class="details">
                    <h2><%%></h2>
